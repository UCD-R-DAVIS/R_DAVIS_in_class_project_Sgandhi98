...
f_to_k <- function(tempF){((tempF - 32) * (5/9)) + 273.15
  }
f_to_k
f_to_k(tempF = 72)
...
f_to_k <- function(tempF){ k <- ((tempF - 32) * (5/9)) + 273.15
  return(k)
}
...
#generalize this where we change county and year range
