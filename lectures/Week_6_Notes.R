...
ggplot(data = surveys, mapping = aes(x = weight, y = hindfoot_length)) + #aestethics
  geom_point(aes(color = genus)) + 
  geom_smooth(aes(color = genus))

## Universal geom settings
ggplot(data = surveys, mapping = aes(x = weight, y = hindfoot_length, color = genus)) + #aestethics
  geom_point() + 
  geom_smooth()
...
ggplot(data = surveys_wt_cat, aes(x = weight_cat, y = hindfoot_length)) +
  ...
  geom_point(alpha = .1) #shows mean or median and gives range of values. 
...
ggplot(data = surveys_wt_cat, aes (x = weight_cat, y = hindfoot_length)) +
  geom_jitter(alpha = .1) + 
  geom_boxplot(aes(color = weight_cat), alpha = .8) 
